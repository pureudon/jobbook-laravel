...
class TCPDFSample3Service
{
    ...
    public function pdf_envelope_content($pdf,$companyname1,$companyname2,$companyaddr1,$companyaddr2,$label_attn,$attn,$label_tel,$company_tel,$label_fax,$company_fax,$label_email,$company_email)
    {
        ...
        // companynam1
        $pdf->writeHTMLCell($w=80,$h=5,$x=$env_x+15,$y=$env_y+50,$companyname1,$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);

        // companynam2
        $pdf->writeHTMLCell($w=80,$h=5,$x=$env_x+15,$y=$env_y+55,$companyname2,$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);

        // addr
        $pdf->writeHTMLCell($w=80,$h=5,$x=$env_x+15,$y=$env_y+60,$companyaddr1,$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);

        // addr2
        $pdf->writeHTMLCell($w=80,$h=5,$x=$env_x+15,$y=$env_y+65,$companyaddr2,$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);
        
        // emptyline
        $pdf->writeHTMLCell($w=80,$h=5,$x=$env_x+15,$y=$env_y+70,'',$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);

        // attn
        $pdf->writeHTMLCell($w=15,$h=5,$x=$env_x+15,$y=$env_y+75,$label_attn,$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);
        $pdf->writeHTMLCell($w=65,$h=5,$x=$env_x+30,$y=$env_y+75,$attn,$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);

        // tel
        $pdf->writeHTMLCell($w=15,$h=5,$x=$env_x+15,$y=$env_y+80,$label_tel,$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);
        $pdf->writeHTMLCell($w=25,$h=5,$x=$env_x+30,$y=$env_y+80,$company_tel,$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);

        // fax
        $pdf->writeHTMLCell($w=15,$h=5,$x=$env_x+55,$y=$env_y+80,$label_fax,$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);
        $pdf->writeHTMLCell($w=25,$h=5,$x=$env_x+70,$y=$env_y+80,$company_fax,$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);

        // email
        $pdf->writeHTMLCell($w=15,$h=5,$x=$env_x+15,$y=$env_y+85,$label_email,$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);
        $pdf->writeHTMLCell($w=65,$h=5,$x=$env_x+30,$y=$env_y+85,$company_email,$border=0,$ln=0,$fill=0,$reseth=true,$align='L',$autopadding=false);
    }
    ...
    public function pdf_item_content($pdf,$items)
    {
        ...
        // // items table body
        $view = \View::make('tcpdf.sample3.item_content')
            ->with('items', $items);
        $html = $view->render();
    ...
    public function pdf_totalamount($pdf,$totalamount,$debug_border_show=0)
    {
        ...
        $info_x = 210 * 0.8;
        $info_y = 221;
        $pdf::writeHTMLCell($w=30,$h=5,$x=$info_x,$y=$info_y,$html=$totalamount,$border=0,$ln=0,$fill=0,$reseth=true,$align='C',$autopadding=false);
    }
    ...
    public function pdf_paymentmethod($pdf)
    {
        ...
        $html .= "<br>";
        $html .= "付款後請將收據 Email 或 WhatsApp 回覆以確認";
    ...
    public function pdf_page_header($pdf,$header_companynamezh,$style,$header_companynameen1,$header_companynameen2)
    {
        ...
        $pdf->writeHTMLCell($w=100, $h=0, $x=10, $y=20, $html=$header_companynamezh, $border=0, $ln=0, $fill=false, $reseth=true, $align='L', $autopadding=true);

        // line2
        $html = '<span style="'.$style.'">'.$header_companynameen1.'</span>'.$header_companynameen2;
        $pdf->writeHTMLCell($w=100, $h=0, $x=10, $y=26, $html=$html, $border=0, $ln=0, $fill=false, $reseth=true, $align='L', $autopadding=true);
    ...
    public function pdf_page_title($pdf,$pdf_doc_title)
    {
        ...
        $pdf->writeHTMLCell($w=70, $h=12, $x=130, $y=20, $html=$pdf_doc_title, $border=0, $ln=0, $fill=false, $reseth=true, $align='C', $autopadding=true);
    }
    ...
    public function pdf_item_frame($pdf,$column1,$column2,$column3,$column4,$column5,$column6,$label_totalamount,$label_amountdue)
    {
        ...
        $x = $pdf->getX();
        $y = $pdf->getY();
        $view = \View::make('tcpdf.sample3.item_frame')
